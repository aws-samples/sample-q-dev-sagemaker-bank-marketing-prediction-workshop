...
The migration is taught through the [companion workshop walkthrough](https://catalog.us-east-1.prod.workshops.aws/workshops/be5424c9-7f99-4311-8294-d199a9d485c7/en-US) using **Kiro** — both the Kiro IDE chat panel and the Kiro CLI. Every prompt in the walkthrough is presented with two tabs (IDE / CLI) — pick the surface that matches your environment.
